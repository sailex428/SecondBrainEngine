...
public class MovementPillar extends Movement {
    ...
    public static BetterBlockPos[] buildPositionsToBreak(Entity entity, BetterBlockPos start) {
        ...
        int requiredVerticalSpace = MathHelper.ceil(/*? =1.20.1 {*/ dims.height /*?} elif =1.21.1 {*//* dims.height() *//*?}*/);
        ...
        if (ladder) {
            ...
            if (!blockIsThere) {
                ...
                if (!(frState.isAir() || frState.isReplaceable())) {
                    RotationUtils.reachable(ctx.entity(), src, ctx.interactionController().getBlockReachDistance())
